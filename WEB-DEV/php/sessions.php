<?php
  session_start();
  $_SESSION["firstName"] = "Bishal";
  $_SESSION["lastName"] = "Raktim";
  $_SESSION["emailAddress"] = "raktimbishal@gmail.com";
      ...
      <form name="myForm" class="form-horizontal" role="form" action="#" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            if (isset($_SESSION["firstName"])) {echo $_SESSION["firstName"];}?>" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            if (isset($_SESSION["lastName"])) {echo $_SESSION["lastName"];}?>" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="email" name="emailAddress" class="form-control" value="<?php
            if (isset($_SESSION["emailAddress"])) {echo $_SESSION["emailAddress"];}?>" required>
          </div>
        </div>
